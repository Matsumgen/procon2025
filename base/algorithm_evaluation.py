...
for i in range(n):
  ...
  try:
    ...
    print(f"[{i+1}/{n}]\t", "size:", res[0], "\ttime:", res[1], "\tstep:", res[2])
    results.append(res)
...
print(f"size: {results[0][0]}")
print(f"time: mean:{s[0][1]}\tmax:{s[1][1]}\tmin:{s[2][1]}\tmedian:{s[3][1]}\tstd:{s[4][[1]]}")
print(f"step: mean:{s[0][2]}\tmax:{s[1][2]}\tmin:{s[2][2]}\tmedian:{s[3][2]}\tstd:{s[4][[2]]}")
